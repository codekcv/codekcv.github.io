          ...
          {useMemo(
            () => (
              ...
              >
                ...
                <p>
                  I'm Christian Villamin, a web developer specializing in
                  ReactJS & NodeJS. I love JavaScript, open source, and learning
                  new things.
                </p>
                <br />
                ...
                <p>
                  ...
                  . I learned it by reading guides & documentations online, and
                  since then have enjoyed the art of programming to heart. I
                ...
                <p>
                  ...
                  in 2012 to build basic desktop app. In 2013, I joined a
                  ...
                  to make 1st person games, although nothing serious, just for
                  fun and messing around with my friends. I did learn maths in
                  3D, so that's nice. This year, 2019, I'm stepping in for good
                  in the wonderful world of web development and beyond.
                </p>
                <br />
                ...
                <p>
                  I enjoy reading fantasy & mystery books. I'm learning &
                  playing piano(
                  <a
                  ...
                  ). I like walking around outside to arrange my thoughts. I
                  drink your average joe coffee everyday. I want to play{' '}
                  <a
          ...
          {useMemo(
            () => (
              ...
              >
                ...
                <p>
                  I have a keen interest in doing web development. Looking to
                  learn, I found{' '}
                  <a
                  ...
                  . I finished its curriculum that has an estimated course work
                  of 1800 hours. I solved 800+ challenges and built a total of
                  30 projects of my own work, passing all unit testing, and
                  submitted to get my certifications in the span of{' '}
                  <a
                ...
                <br />
                <p>
                  Having programming background, learning
                  JavaScript(ES6+/Algos/DOM Manipulations) was a breeze.
                  Meanwhile, HTML5 & CSS3 are much easier languages to learn
                  from having that standpoint.
                </p>
                <br />
                <p>
                  After that, I focused my learning on the latest and greatest
                  web technologies;{' '}
                  <a
                  ...
                  environment surrounding those two primary technologies. I'm
                ...
                <p>
                  ...
                  challenge has been a huge help to my learning, as I was able
                  to relate, help, and share thoughts to many people who are
